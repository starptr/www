---
title: "Discrete Calculus: Definition of Discrete Derivative"
...
According to [Wikipedia](https://en.wikipedia.org/wiki/Finite_difference), this is known as a **finite difference**. The formal notation uses a subscript to show the size of the difference between arguments like so:
